...
class PropertyValueImpl implements PropertyValue {
    ...
    public ObjectValue[] multipleObject() {
        Value[] vals = multiple();
        ObjectValue[] result = new ObjectValue[vals.length];
        for (int i = 0; i < vals.length; i++) {
            result[i] = vals[i].objectValue();
        }
        return result;
    }
    ...
    public LocalDate[] multipleDate() {
        Value[] vals = multiple();
        LocalDate[] result = new LocalDate[vals.length];
        for (int i = 0; i < vals.length; i++) {
            result[i] = vals[i].dateValue();
        }
        return result;
    }
    ...
    public LocalDateTime[] multipleDatetime() {
        Value[] vals = multiple();
        LocalDateTime[] result = new LocalDateTime[vals.length];
        for (int i = 0; i < vals.length; i++) {
            result[i] = vals[i].datetimeValue();
        }
        return result;
    }
    ...
    public LocalTime[] multipleTime() {
        Value[] vals = multiple();
        LocalTime[] result = new LocalTime[vals.length];
        for (int i = 0; i < vals.length; i++) {
            result[i] = vals[i].timeValue();
        }
        return result;
    }
    ...
    public Boolean[] multipleBoolean() {
        Value[] vals = multiple();
        Boolean[] result = new Boolean[vals.length];
        for (int i = 0; i < vals.length; i++) {
            result[i] = vals[i].booleanValue();
        }
        return result;
    }
