...
public class ContextSpecParserJs {
    ...
    public ContextSpecParserJs( Map<String, ?> root ) {
        this.root = root;
    }
...
//                typeSpec.embeddedValueSpec( this.createEnum() );
    ...
    private TypeTokenJs parseType( String typeSpec ) throws SpecSyntaxException {
        TypeTokenJs type;
        try {
            type = TypeTokenJs.parse( typeSpec );
