 ...
 */
public class JsonWriterKeepNullValuesGenerationTest {
    @Rule
...
//    private Spec spec;
    ...
    public void setUp() throws Exception {
        ...
        new JsonFrameworkGenerator(spec, "org.generated.ref", dir.getRoot(), ValueWriter.NullStrategy.KEEP).generate();

        spec = loadSpec("spec.yaml");
        new SpecCodeGenerator(spec, "org.generated", dir.getRoot()).generate();
        new JsonFrameworkGenerator(spec, "org.generated", dir.getRoot(), ValueWriter.NullStrategy.KEEP).generate();

        spec = loadSpec("raw-naming.yaml");
        new SpecCodeGenerator(spec, "org.generated.raw", dir.getRoot()).generate();
        new JsonFrameworkGenerator(spec, "org.generated.raw", dir.getRoot(), ValueWriter.NullStrategy.KEEP).generate();
